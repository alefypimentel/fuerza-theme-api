...
// Registrar Taxonomia de Categoria de Testes usando o sistema dinâmico
Content_Manager::register_taxonomy('categoria_teste', ['teste'], [
    'singular_name' => 'Categoria de Teste',
    'plural_name' => 'Categorias de Testes',
    'description' => 'Categorias para organizar Testes',
    'hierarchical' => true,
    'public' => true,
    'show_in_rest' => true,
    'rest_base' => 'categoria_teste',
    'show_ui' => true,
    'show_in_menu' => true,
    ...
    'hooks' => [
        'created_categoria_teste' => function($term_id) {
            if (function_exists('wp_cache_delete')) {
                wp_cache_delete('categoria_teste_list', 'fuerza_theme');
            }
        }
    ]
]);
